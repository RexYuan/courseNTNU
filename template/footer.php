        ...
        <div class="modal fade" id="easterEggModal" tabindex="-2" role="dialog" aria-labelledby="easterEggModal" aria-hidden="true">
        	...
        	<div class="row">
              ...
              <h6 class="text-center"><a href="#">關於</a>-<a href="<?= $urlroot ?>policy.html">隱私權政策</a>-<a href="http://survive.coursentnu.com/">Survive NTNU</a>-<a href="https://www.facebook.com/CommunityNTNU">Facebook</a></h6>
            	</div>
        	</div>
        </div>
    </body>
