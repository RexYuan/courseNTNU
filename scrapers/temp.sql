...
(
	...
	CourseCode INT UNSIGNED NOT NULL,
...
CREATE TABLE Subs
(
	SubsId INT UNSIGNED AUTO_INCREMENT NOT NULL,
	CourseRecordId INT UNSIGNED NOT NULL,
	UserId INT UNSIGNED NOT NULL,
	SubTime TIMESTAMP NOT NULL,
	PRIMARY KEY (SubsId),
	FOREIGN KEY (CourseRecordId) REFERENCES CourseRecords(CourseRecordId),
	FOREIGN KEY (UserId) REFERENCES Users(UserId),
	CONSTRAINT OneSubPerUser UNIQUE (CourseRecordId, UserId)
);
